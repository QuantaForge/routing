...
use QuantaForge\Routing\Contracts\CallableDispatcher;
...
use QuantaForge\Routing\Matching\HostValidator;
use QuantaForge\Routing\Matching\MethodValidator;
use QuantaForge\Routing\Matching\SchemeValidator;
use QuantaForge\Routing\Matching\UriValidator;
...
class Route
{
    ...
    public function getMissing()
    {
        ...
        return is_string($missing) &&
            Str::startsWith($missing, [
                'O:47:"QuantaForge\\SerializableClosure\\SerializableClosure',
                'O:55:"QuantaForge\\SerializableClosure\\UnsignedSerializableClosure',
     ...
     *
     * @return \QuantaForge\Routing\Contracts\ControllerDispatcher
     */
