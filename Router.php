...
use QuantaForge\Contracts\Routing\Registrar as RegistrarContract;
...
use QuantaForge\Routing\Events\RouteMatched;
...
/**
 * @mixin \QuantaForge\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \QuantaForge\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \QuantaForge\Routing\Route|null
     */
    protected $current;
    ...
    {
        return $this->any($uri, '\QuantaForge\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\QuantaForge\Routing\ViewController')
                ->setDefaults([
                    'view' => $view,
                    'data' => $data,
     ...
     *
     * @param  \QuantaForge\Support\Collection  $middlewares
     * @return array
     */
     ...
     *
     * @return \QuantaForge\Routing\RouteCollectionInterface
     */
