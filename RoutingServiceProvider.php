...
use QuantaForge\Contracts\View\Factory as ViewFactoryContract;
        ...
        $this->app->bind(ServerRequestInterface::class, function ($app) {
            if (class_exists(Psr17Factory::class) && class_exists(PsrHttpFactory::class)) {
                ...
                return with((new PsrHttpFactory($psr17Factory, $psr17Factory, $psr17Factory, $psr17Factory))
                    ->createRequest($quantaforgeRequest = $app->make('request')), fn ($request) => $request->withParsedBody(
                        array_merge($request->getParsedBody(), $quantaforgeRequest->getPayload()->all())
                    ));
            }
