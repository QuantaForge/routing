...
use BackedEnum;
use Closure;
use QuantaForge\Contracts\Routing\UrlGenerator as UrlGeneratorContract;
...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \QuantaForge\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param  \QuantaForge\Routing\RouteCollectionInterface  $routes
     ...
     * @return string
     *
     * @throws \QuantaForge\Routing\Exceptions\UrlGenerationException
     */
     ...
     * @param  string  $root
     * @param  string  $path
     * @param  \QuantaForge\Routing\Route|null  $route
     * @return string
     */
     ...
     *
     * @return \QuantaForge\Routing\RouteUrlGenerator
     */
     ...
     *
     * @return \QuantaForge\Session\Store|null
     */
